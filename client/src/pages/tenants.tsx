              ...
              <div className="overflow-x-auto">
                <table className="w-full">
                  <thead className="bg-muted">
                    <tr>
                      <th className="text-left text-sm font-medium text-muted-foreground px-6 py-4">Tenant</th>
                      <th className="text-left text-sm font-medium text-muted-foreground px-6 py-4">Rent Amount</th>
                      <th className="text-left text-sm font-medium text-muted-foreground px-6 py-4">Status</th>
                      <th className="text-left text-sm font-medium text-muted-foreground px-6 py-4">Lease Period</th>
                      ...
                      <tr key={tenant.id} className="hover:bg-muted" data-testid={`row-tenant-${tenant.id}`}>
                        <td className="px-6 py-4">
                          <div className="flex items-center">
                            <div className="w-10 h-10 bg-primary rounded-full flex items-center justify-center text-primary-foreground text-sm font-medium mr-4">
                        ...
                        <td className="px-6 py-4 font-medium text-foreground">
                          {tenant.rentAmount} TND
                        </td>
                        <td className="px-6 py-4">
                          {getStatusBadge(tenant.paymentStatus)}
                        </td>
                        <td className="px-6 py-4 text-muted-foreground">
                          <div>{formatDate(tenant.leaseStart.toString())} - {formatDate(tenant.leaseEnd.toString())}</div>
                        </td>
                        <td className="px-6 py-4">
                          <div className="flex items-center space-x-2">
                            ...
                            <Button
                              variant="ghost"
                              size="sm"
                              data-testid={`button-send-reminder-${tenant.id}`}
                            >
