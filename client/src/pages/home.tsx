          ...
          <div className="lg:grid lg:grid-cols-2 lg:gap-8 items-center">
            <div>
              <h1 className="text-4xl lg:text-6xl font-bold leading-tight mb-6">
                Protect Your Rent with <span className="text-blue-200">GLI Insurance</span>
              </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="hover:shadow-lg transition-shadow duration-200 transform hover:-translate-y-1">
              <CardContent className="p-8">
                ...
                <h3 className="text-xl font-semibold mb-4 text-foreground">Tenant Management</h3>
            ...
            <Card className="hover:shadow-lg transition-shadow duration-200 transform hover:-translate-y-1">
              <CardContent className="p-8">
                ...
                <h3 className="text-xl font-semibold mb-4 text-foreground">Premium Calculator</h3>
                <p className="text-muted-foreground mb-4">
            ...
            <Card className="hover:shadow-lg transition-shadow duration-200 transform hover:-translate-y-1">
              <CardContent className="p-8">
                ...
                <h3 className="text-xl font-semibold mb-4 text-foreground">Dashboard Insights</h3>
                <p className="text-muted-foreground mb-4">
